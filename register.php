	...
	<body>
		<div class="container">
			...
			if(isset($_POST['save']))
			{
				...
				mysqli_query($con,"INSERT INTO parents(parents_name,parents_email,password,mobile,gender,ip) VALUES('$uname','$email','$hpass','$mobile','$gender','$ip')");
				
				if(mysqli_affected_rows($con)==1)
				{
					$token = base64_encode($email);
					$subject = "Account Activation";
					$message = "Hi ".$uname."<br>, Thanks Your account created successfully. Please click the below link to activate your account.<br><br><a href='http://localhost/login-rfidattendance/activate.php?key=".$token."' target='_blank'>Activate Now</a><br><br>Thanks<br>Team";
			...
			<form autocomplete="off" method="POST" action="" onsubmit="return registerValidate()">
				...
				<div class="formgroup">
					<label>Name:</label>
					<input type="text" onfocus="hideError(this)" onblur="checkError(this)" name="name" id="uname" class="formcontrol"/>
					<small class="errormsg" id="name_error"></small>
				</div>
				...
				<div class="formgroup">
					<a href="login_users.php" class="btn">Login</a>
				</div>
		</div>
