...
<head>
    ...
    <script>
      $(document).ready(function(){
        $.ajax({
          url: "user_log_up_users.php",
          type: 'POST',
          data: {
              'select_date': 1,
          }
          }).done(function(data) {
            $('#userslog_users').html(data);
          });
...
<section class="container py-lg-5">
  <!--User table-->
    <h1 class="slideInDown animated">Student Attandance Daily Record</h1>
